...
<head>
    ...
    <title> Your Care Hospital </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">YCH
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Your Care Hospital</h5>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 map-img">
                    <h2>Contact Us: Yourcarehospital@gmail.com<br>
                                    6584795463<br>  
                                    25465154<br>
                                    41554154548
                    </h2>
